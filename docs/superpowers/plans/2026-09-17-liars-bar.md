...
- Produces:
  - `make_adapter(Log, DB, Ids, Interactables, Intents, Engine, Appearances, config, spawn) -> Adapter`
...
return function(Log, DB, Ids, Interactables, Intents, Engine, Appearances, config, spawn)
    local Adapter = {}
    ...
    function Adapter.Seat(player, seat, cid)
        ...
        seated[#seated + 1] = {
            player       = player,
            seat         = seat,
            character_id = player:GetValue("character_id"),
        }
...
local LiarsBar = Package.Require("games/liars_bar/adapter.lua")(
    Log, DB, Ids, Interactables, Intents,
